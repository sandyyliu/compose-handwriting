...
import com.sz.handwriting.viewmodel.SpringBoardViewAction
import com.sz.handwriting.viewmodel.SpringBoardViewModel
import com.sz.handwriting.viewmodel.SpringBoardViewStates
...
@Composable
fun SpringPage(viewModel: SpringBoardViewModel = viewModel(), onPreview: () -> Unit) {
...
fun BoardContent(viewModel: SpringBoardViewModel, bitmap: Bitmap, newCanvas: Canvas) {
    ...
    BoxWithConstraints(
        ...
        Image(
            painter = painterResource(id = com.sz.handwriting.R.mipmap.icon_draw_bg),
            modifier = Modifier
                .fillMaxSize(),
            contentDescription = ""
        )
...
fun ConfirmBtn(modifier: Modifier, states: SpringBoardViewStates, onPreview: () -> Unit) {
    Button(
        ...
        modifier = modifier
            ...
            .padding(16.dp)
            .height(50.dp),
        colors = ButtonDefaults.buttonColors(contentColor = Primary)
    ) {
        Text(text = "生成春联")
    }
}
...
fun ImageList(viewModel: SpringBoardViewModel) {
    ...
    BoxWithConstraints(
        ...
        Image(
            painter = painterResource(id = com.sz.handwriting.R.mipmap.icon_delete),
            contentDescription = "",
            modifier = Modifier
                .align(
                    Alignment.TopEnd
...
fun DividerTab(viewModel: SpringBoardViewModel, bitmap: Bitmap, newCanvas: Canvas) {
    ...
    Row(
        ...
        Image(
            painter = painterResource(id = com.sz.handwriting.R.mipmap.icon_confirm),
            modifier = Modifier
                .wrapContentSize()
                .clickable {
